...
const SalaryPage = () => {
    ...
    return (
        <div className='maxw-w-screen-2x1 container mx-auto xl:px-24 px-4'>
            <PageHeader title={"Perkiran Gaji"} path={"Gaji"}/>
                <div className='mt-5'>
                    <div className='seacrh-box p-2 text-center mb-2'>
                            ...
                            <button onClick={handleSearch} className='bg-blue text-white font-semibold px-8 py-2 rounded-sm mb-4'>Cari</button>
                    </div>
                </div>
                {/* salary display card */}
                <div className='grid lg:grid-cols-3 sm:grid-cols-2 grid-cols-1 gap-12 my-12 item'>
                    {
                        salary.map((data) => (
